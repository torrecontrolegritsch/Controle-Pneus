  ...
  <section class="gp-section">
    ...
    <div v-if="pneusAguardando.length > 0" class="aguardando-lote-box">
      <div class="box-header">
        ...
        <button class="btn-primary" :disabled="selected.length === 0" @click="gerarLote">
          Gerar Lote com {{ selected.length }} Selecionados
        </button>
      </div>
      <div class="aguardando-grid">
        <div
          v-for="p in pneusAguardando" :key="p.id"
